...
if(isset($_POST[POST_EXTERN_SERVER_ACTION]))
{
	...
	else
	{
		...
		unregisterChat(AJAXDecode(@$_POST[POST_EXTERN_CHAT_ID]));
	...
	if(!dataSetExists($externalUser->ExternalStatic->SessionFile) && isset($_POST[POST_EXTERN_RESOLUTION_WIDTH]))
		createStaticFile($externalUser,Array(AJAXDecode($_POST[POST_EXTERN_RESOLUTION_WIDTH]),AJAXDecode($_POST[POST_EXTERN_RESOLUTION_HEIGHT])),AJAXDecode($_POST[POST_EXTERN_COLOR_DEPTH]),AJAXDecode($_POST[POST_EXTERN_TIMEZONE_OFFSET]),AJAXDecode(@$_POST[GEO_LATITUDE]),AJAXDecode(@$_POST[GEO_LONGITUDE]),AJAXDecode(@$_POST[GEO_COUNTRY_ISO_2]),AJAXDecode(@$_POST[GEO_CITY]),AJAXDecode(@$_POST[GEO_REGION]),AJAXDecode(@$_POST[GEO_TIMEZONE]),AJAXDecode(@$_POST[GEO_ISP]),AJAXDecode(@$_POST[GEO_SSPAN]),AJAXDecode(@$_POST[GEO_RESULT_ID]));
