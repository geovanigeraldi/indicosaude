<table cellspacing="0" cellpadding="0" style="background-image:url('<!--server-->templates/invitations/classic/background_header.gif');background-repeat:no-repeat;background-position:center left;" width="302" height="302" border="0">
	<tr>
...
<input type="text" id="lz_invitation_name" style="position:absolute;left:11px;top:262px;background-image:url('<!--server-->templates/invitations/classic/textbox.gif');background-repeat:no-repeat;border:0px;height:14px;width:160px;font-size:11px;padding:3px;color:#707070;">
