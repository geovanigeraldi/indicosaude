<table cellspacing="0" cellpadding="0" style="background-image:url('<!--server-->templates/invitations/<!--template-->/background.gif');background-repeat:no-repeat;background-position:center left;" width="400" height="132" border="0">
	<tr>
		<td></td>
	</tr>
</table>
...
<input type="text" id="lz_invitation_name" style="position:absolute;left:105px;top:104px;background-image:url('<!--server-->templates/invitations/<!--template-->/textbox.gif');background-repeat:no-repeat;border:0px;height:14px;width:158px;font-size:11px;padding:3px;color:#707070;">
