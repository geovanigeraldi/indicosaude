...
{
	if(lz_chat_data.Status.Status == lz_chat_data.STATUS_ALLOCATED && !lz_chat_data.WaitingMessageAppended)
	{
...
function lz_chat_initiate_forwarding(_group)
{
	...
	{
		frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0'].document.getElementById('lz_chat_queue_position').id = "oq_a" + lz_global_timestamp();
		frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0'].document.getElementById('lz_chat_queue_waiting_time').id = "oq_b" + lz_global_timestamp();
...
function lz_chat_show_queue_position(_position,_time)
{
	...
	var cposition = parseInt(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0'].document.getElementById('lz_chat_queue_position').innerHTML);
	var cwtime = parseInt(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0'].document.getElementById('lz_chat_queue_waiting_time').innerHTML);
	
	if(_position == 1 && (cposition != _position))
		lz_chat_add_system_text(9,"");
		
	if(cposition == -1 || (_position > 0 && _position <= cposition))
		frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0'].document.getElementById('lz_chat_queue_position').innerHTML = _position;
		
	if(cwtime == -1 || (_time > 0 && _time <= cwtime))
		frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0'].document.getElementById('lz_chat_queue_waiting_time').innerHTML = _time;
}
...
{	
	...
	if(_type == 0)
		...
		text = lz_chat_data.Language.ClientIntLeft + " <a href=\"javascript:top.lz_chat_goto_message(true);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 4)
		text = lz_chat_data.Language.ClientIntDeclined + " <a href=\"javascript:top.lz_chat_goto_message(true);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 5)
		text = lz_chat_data.Language.ClientStillWaitingInt + " <a href=\"javascript:top.lz_chat_goto_message(true);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou; 
	else if(_type == 6)
		text = lz_chat_data.Language.ClientIntIsConnected;
	else if(_type == 8)
		text = lz_chat_data.Language.ClientNoInternUsers + " <a href=\"javascript:top.lz_chat_goto_message(true);\"><b>" + lz_chat_data.Language.LanguageLeaveMessageShort + "</b></a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 9)
...
{	
	if(lz_chat_data.Status.Status != _status && _status == lz_chat_data.STATUS_ALLOCATED)
	{
		if(lz_chat_data.TimerWaiting != null)
			clearTimeout(lz_chat_data.TimerWaiting);
		lz_chat_data.TimerWaiting = setTimeout("lz_chat_show_waiting_message();",90000);
	}
	if(lz_chat_data.Status.Status < lz_chat_data.STATUS_STOPPED)
