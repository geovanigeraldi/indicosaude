<table cellspacing="0" cellpadding="0" style="background-image:url('<!--server-->templates/invitations/<!--template-->/background.gif');background-repeat:no-repeat;background-position:center left;" width="302" height="220" border="0">
	<tr>
		<td></td>
	</tr>
</table>
...
<div style="position:absolute;left:10px;top:38px;"><img alt="<!--intern_name-->" src="<!--server--><!--intern_image-->" border="0"></div>
...
<input type="text" id="lz_invitation_name" style="position:absolute;left:11px;top:180px;background-image:url('<!--server-->templates/invitations/<!--template-->/textbox.gif');background-repeat:no-repeat;border:0px;height:14px;width:160px;font-size:11px;padding:3px;color:#707070;">
