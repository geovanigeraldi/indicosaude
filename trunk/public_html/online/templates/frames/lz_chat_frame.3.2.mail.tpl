...
<body leftmargin="0" topmargin="0" onload="document.getElementById('lz_chat_mail_details').style.display='block';">
	...
	<form name="lz_login_form" method="post" action="./<!--file_chat-->?template=lz_chat_frame.3.2.chat" target="lz_chat_frame.3.2" style="padding:0px;margin:0px;">
			...
			<td align="center" valign="top">	
				...
				<div id="lz_chat_mail_details">
					<table cellpadding="5" cellspacing="3">
						<tr>
							<td class="lz_chat_form_field" width="150"><strong><!--lang_client_your_name-->:</strong></td><td width="220"><input name="name" id="lz_chat_mail_name" class="lz_chat_mail_box" value="<!--login_value_111-->" maxlength="32"><span class="lz_index_red" id="lz_chat_login_mandatory">&nbsp;*</span></td>
						</tr>
						<tr>
							<td class="lz_chat_form_field"><strong><!--lang_client_your_email-->:</strong></td><td><input name="email" id="lz_chat_mail_email" class="lz_chat_mail_box" value="<!--login_value_112-->" maxlength="50"><span class="lz_index_red" id="lz_chat_login_mandatory">&nbsp;*</span></td>
						</tr>
						<tr>
							<td class="lz_chat_form_field"><!--lang_client_your_company-->:</td><td><input name="company" id="lz_chat_mail_company" class="lz_chat_mail_box" value="<!--login_value_113-->" maxlength="50"></td>
						</tr>
						<tr>
						...
						<tr>
							<td height="40"></td>
							<td><span class="lz_index_red" id="lz_chat_login_mandatory">* <!--lang_client_required_field--></span></td>
						</tr>
					</table>
				</div>
			</td>
