function lz_group(_id,_amount,_description,_email,_document,_ihidden,_imandatory)
{
	this.Id = _id;
	this.Amount = _amount;
	...
	this.Changed = false;
	this.UpdateOption();
	this.InputsHidden = _ihidden;
	this.InputsMandatory = _imandatory;
...
function lz_group_list(_document,_selectBox)
{
	...
	function lz_group_list_add(_id,_amount,_description,_email,_ihidden,_imandatory)
	{
		var existing = false;
		var currentGroup;
		var lastGroup;
		...
		if(!existing)
		{
			currentGroup = new lz_group(_id,_amount,_description,_email,this.ActiveDocument,_ihidden,_imandatory);
