...
{
	lz_chat_data.ExternalUser.Username = lz_global_replacements(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName('login_111')[0].value.substr(0,32),false);
	lz_chat_data.ExternalUser.Email = lz_global_replacements(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName('login_112')[0].value.substr(0,50),false);
	lz_chat_data.ExternalUser.Company = lz_global_replacements(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName('login_113')[0].value.substr(0,50),false);
	lz_chat_data.ExternalUser.Question = lz_global_replacements(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName('login_114')[0].value.substr(0,1000),false);

	for(var i=0;i<=9;i++)
		if(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName('login_'+i).length == 1)
			lz_chat_data.ExternalUser.CustomFields[i] = frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName('login_'+i)[0].value;
...
function lz_chat_change_group()
{
	...
	if(lz_chat_data.Status.Status > lz_chat_data.STATUS_START || lz_selected_group != null)
	{
		...
		lz_chat_set_input_fields(lz_selected_group);
		return;
	}
...
function lz_chat_set_input_fields(_selGroup)
{
	...
	for(var i = 0;i < lz_chat_data.InputFieldIndices.length;i++)
	{
		...
		if(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_" + findex) != null)
		{
			frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_" + findex).style.display = (lz_array_indexOf(_selGroup.InputsHidden,findex) > -1) ? "none":"block";
			frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_mandatory_" + findex).style.display = (lz_array_indexOf(_selGroup.InputsMandatory,findex) == -1) ? "none":"block";
			if(lz_array_indexOf(_selGroup.InputsMandatory,findex) != -1)
				mandatoryFields = true;
		}
	}
	frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_mandatory").style.display = (mandatoryFields) ? "block" : "none";
}
...
function lz_chat_goto_message(_inChat)
{
	...
	if(!_inChat)
	{
		frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.lz_login_form.action = './<!--file_chat-->?template=lz_chat_frame.3.2.mail&' + lz_chat_data.GetParameters;
		frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.lz_login_form.submit();
	}
	else
	{
...
function lz_chat_check_login_inputs()
{
	...
	for(var i = 0;i < lz_chat_data.InputFieldIndices.length;i++)
	{
		...
		if(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_" + findex) != null)
		{
			if(lz_array_indexOf(lz_selected_group.InputsMandatory,findex) != -1 && lz_global_trim(frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementsByName("login_" + findex)[0].value).length == 0)
			{
				frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_caption_" + findex).className = "lz_chat_form_field_red";
				missingInput = true;
			}
			else
				frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.login.1.0'].document.getElementById("lz_chat_login_caption_" + findex).className = "lz_chat_form_field";
		}
	}
