	...
	<div id="wrapper">
		<div id="page">
			<div id="header">
				...
				<div id="rss" title="Acompanhe nosso RSS Feed">
					<a href="<?php bloginfo('rss2_url'); ?>">Acompanhe via RSS</a>
				</div>
				<div id="menu">
					<ul>
						<li<?php if ( is_home() ) { ?> class="current_page_item"<? } ?> id="homelink"><a href="<?php echo get_option('home'); ?>/" title="<?php bloginfo('name'); ?>">Inicial</a></li>
						<?php wp_list_pages('title_li='); ?>
						<li><a href="<?php bloginfo('rss2_url'); ?>" title="Subscribe Via RSS">RSS</a></li>
					</ul>
				<div id="searchetc">
