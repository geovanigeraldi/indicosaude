...
function hybrid_site_title() {
	...
	if ( $title = get_bloginfo( 'name' ) )
		...
		//$title = '<' . $tag . ' id="site-title"><a href="' . home_url() . '" title="' . esc_attr( $title ) . '" rel="home"><span>' . $title . '<img src="wp-content/themes/news/images/logo1.png"></span></a></' . $tag . '>';
		$title = '<' . $tag . ' id="site-title"><a href="' . home_url() . '" title="' . esc_attr( $title ) . '" rel="home"><img src="wp-content/themes/news/images/logo1.png">' . $title . '</a></' . $tag . '>';
